...
//   Future<List<Event>> eventsList = DBProvider.instance.getEventsForUser(1);
...
//         future: DBProvider.instance.getEventsForUser(1),
...
//           await DBProvider.instance.addEvent(eventTest);
//           setState(() {});
//         },
//       ),
//     );
